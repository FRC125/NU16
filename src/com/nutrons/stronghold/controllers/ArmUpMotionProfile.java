...
public class ArmUpMotionProfile {
	 ...
	 */
	public ArmUpMotionProfile(CANTalon talon) {
		_talon = talon;
		/*
	...
	private void startFilling() {
		...
		startFilling(ArmUpGeneratedMotionProfile.Points, ArmUpGeneratedMotionProfile.kNumPoints);
	}
