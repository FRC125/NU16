...
public class SplineProfile {
	...
	// Contains the trajectory created by Team254 TrajectoryLib ready to be send to TalonSRX
	private TrajectoryWrapper _trajectory;
	 ...
	 */
	public SplineProfile(CANTalon talon, TrajectoryWrapper trajectory) {
		_talon = talon;
		/*
	...
	private void startFilling() {
		...
		startFilling(_trajectory.get(), _trajectory.getNumberOfPoints());
	}
