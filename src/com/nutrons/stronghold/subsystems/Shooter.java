...
public class Shooter extends Subsystem {
	...
	private DoubleSolenoid shooter3 = new DoubleSolenoid(RobotMap.SHOOTER3_A, RobotMap.SHOOTER3_B);
	private DoubleSolenoid shooter4 = new DoubleSolenoid(RobotMap.SHOOTER4_A, RobotMap.SHOOTER4_B);
	...
	public void fireShooter() {
		...
		this.shooter3.set(Value.kForward);
		this.shooter4.set(Value.kForward);
	}
	
	public void retractShooter() {
		this.shooter1.set(Value.kReverse);
		this.shooter2.set(Value.kReverse);
		this.shooter3.set(Value.kReverse);
		this.shooter4.set(Value.kReverse);
	}
}